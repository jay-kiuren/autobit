...
const FinalCTA = () => {
  ...
  const handleClick = (e: React.MouseEvent) => {
    ...
    // Allow the mailto to fire, then show states
  ...
  return (
    <section className="finalcta-section" style={{
      ...
      padding: '100px 24px', borderTop: '1px solid rgba(255,255,255,0.06)', position: 'relative', overflow: 'hidden',
      contain: 'layout',
    }}>
      ...
      <div style={{ display: 'flex', gap: '16px', marginTop: '40px', position: 'relative', zIndex: 1, flexWrap: 'wrap', justifyContent: 'center' }}>
        <a
