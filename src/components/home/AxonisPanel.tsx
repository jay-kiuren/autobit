...
const AxonisPanel = () => (
  <section style={{
    ...
    backgroundImage: 'radial-gradient(ellipse 60% 70% at 100% 50%, rgba(48,209,88,0.07), transparent 70%)',
    position: 'relative', overflow: 'hidden',
  }}>
    {floatingIcons.map(({ Icon, top, left }, i) => (
      <Icon key={i} size={48} style={{ position: 'absolute', top, left, color: 'rgba(48,209,88,0.05)', pointerEvents: 'none', zIndex: 0 }} />
    ))}
    <div style={{ display: 'flex', alignItems: 'center', gap: '40px', position: 'relative', zIndex: 1 }}>
      ...
      <div style={{ width: '55%' }}>
        <div style={{
          ...
          overflow: 'hidden', minHeight: '420px', display: 'flex', flexDirection: 'column',
        }}>
          ...
          <div style={{ padding: '32px', fontFamily: "'JetBrains Mono', 'Fira Code', monospace", fontSize: '14px', lineHeight: 2.0, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
