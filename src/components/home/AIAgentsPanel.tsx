...
const AIAgentsPanel = () => (
  <section className="aiagents-section" style={{
    ...
    <div className="aiagents-inner" style={{ display: 'flex', alignItems: 'center', gap: '40px', position: 'relative', zIndex: 1 }}>
      <div className="aiagents-visual" style={{ width: '55%' }}>
        <div style={{
      ...
      <div className="aiagents-text" style={{ width: '45%' }}>
        ...
        <h2 className="aiagents-heading" style={{ fontFamily: font, fontSize: '56px', fontWeight: 700, letterSpacing: '-2px', lineHeight: 1.0, color: '#ffffff', margin: 0 }}>Custom AI that<br />works 24/7.</h2>
        ...
        <div style={{ display: 'flex', gap: '12px', marginTop: '28px', flexWrap: 'wrap' }}>
          <button onClick={() => window.dispatchEvent(new CustomEvent('open-contact-modal'))} style={{ background: '#2997ff', color: '#ffffff', padding: '12px 28px', borderRadius: '980px', fontSize: '15px', fontWeight: 600, border: 'none', cursor: 'pointer', fontFamily: font }}>Start a project</button>
    ...
    <style>{`
      @media (max-width: 767px) {
        .aiagents-section { padding: 48px 24px !important; }
        .aiagents-inner { flex-direction: column-reverse !important; }
        .aiagents-visual { width: 100% !important; }
        .aiagents-text { width: 100% !important; }
        .aiagents-heading { font-size: 36px !important; }
      }
    `}</style>
  </section>
);
