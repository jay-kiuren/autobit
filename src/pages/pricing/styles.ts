...
export const cardElevation: React.CSSProperties = {
  background: '#1c1c1e',
...
export const hoverIn = (e: React.MouseEvent<HTMLDivElement>) => {
...
export const hoverOut = (e: React.MouseEvent<HTMLDivElement>) => {
